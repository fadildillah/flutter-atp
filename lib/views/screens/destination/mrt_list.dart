...
class MrtList extends StatefulWidget {
  const MrtList({super.key});

  @override
  State<MrtList> createState() => _MrtListState();
}

class _MrtListState extends State<MrtList> {
  ...
  void initState() {
    super.initState();
    destinationController.fetchDestinationByType('mrt').then((_) {
      setState(() {
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Card(
                    ...
                    elevation: 2.0,
                    child: ListTile(
                      leading: Image.asset('assets/mrt.png'),
                      title: Text(filteredDestinations[index].name,
                          style: Theme.of(context).textTheme.titleSmall),
                      subtitle: Obx(() {
                        String cacheKey = 'mrt_$index';
